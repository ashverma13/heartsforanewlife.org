...
<p style="font-size:20px">Together as one we share the missing link, which is LOVE! ©</p>
              </div>
          ...
          <div class="<?php echo $containerClass; ?>">
            <div class="<?php echo $rowClass; ?>">
              <div id="copyright" class="span<?php echo $this->params->get('footerWidth'); ?>">
                ...
                <!-- Footer Logo -->
                <a class="footer_logo" href="<?php echo $this->baseurl; ?>"><img src="<?php echo $footerLogo;?>" alt="<?php echo $sitename; ?>" /></a><br />
  					    <?php else: ?>
                <span class="siteName"><?php echo $sitename; ?></span>
  					    <?php endif; ?>
                
 <!-- Footer org number and phone -->      
                
                Together as one we share the missing link, which is LOVE!©<br>Ecuador Office: +093 334 6417 <Br> Org. Reg. Norway: 911 849 119<br>Org. Reg. Ecuador: 1191750035001 <Br>
                
					      <?php if($this->params->get('footerCopy') == 1) echo '<span class="copy">&copy;</span>'; ?>
					      <?php if($this->params->get('footerYear') == 1) echo '<span class="year">'.date('Y').' HEARTS FOR A NEW LIFE</span>'; ?> 
                ...
                <a class="terms_link" href="<?php echo $terms_link_url; ?>"><?php echo $this->params->get('terms_link_title'); ?></a>
  					    <?php endif; ?>
                <a class="terms_link" href="#donate">DONATE</a>
              </div>
