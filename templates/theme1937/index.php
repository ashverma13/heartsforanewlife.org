...
<p style="font-size:20px">Together as one we share the missing link, which is LOVE! ©</p>
 ...
 <!-- Footer org number -->      
                ...
                Org. Reg. Norway: 911 849 119<br>Org. Reg. Ecuador: 1191750035001<Br>
                ...
                <a class="terms_link" href="<?php echo $terms_link_url; ?>"><?php echo $this->params->get('terms_link_title'); ?></a>
  					    <?php endif; ?>
                <span class="year"><a class="terms_link" href="http://www.heartsforanewlife.org/terms-of-use">TERMS OF USE</a></span> 
                <a class="terms_link" href="http://www.heartsforanewlife.org/donate">DONATE</a>
